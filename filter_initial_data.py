...
def process_file(m123_file, m5_file):
    #%% READ FILES
    m123 = M123File(m123_file, M123_COLUMN_LIST)
    m123 = m123.dropColumns(['type','status'])
...
@click.command()
@click.option('--m123', '-m123', help="Path of m123 file")
@click.option('--m5', '-m5', help="Path of m5 file")
def get_params(m123, m5):
    if not m123:
        m123 = '/home/anna/Documents/AIS/python/out/'+arx+'123'+'.txt'
    if not m5:
        m5 = './out/llista_arx_5.txt'

    process_file(m123, m5)
